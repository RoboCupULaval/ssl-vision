...
private:
  constexpr static const double minZValue = -10;
  constexpr static const double maxZValue = 10;
  constexpr static const double FieldZ = 1.0;
  constexpr static const double RobotZ = 2.0;
  constexpr static const double BallZ = 3.0;
  static const int PreferedWidth = 1024;
  static const int PreferedHeight = 768;
  constexpr static const double MinRedrawInterval = 0.016; ///Minimum time between graphics updates (limits the fps)
